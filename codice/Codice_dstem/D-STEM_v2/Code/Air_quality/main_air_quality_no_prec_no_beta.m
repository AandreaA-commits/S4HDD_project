...
ground.Y{6} = dati_VELVENTO;
ground.Y_name{6} = 'wind_vel';
...
ground.coordinates{6} = [VEL_VENTO_lat, VEL_VENTO_long];
...
obj_stem_validation = stem_validation({'nox','traffic','pm25', 'ben', 'umidity', 'wind_vel'}, ... 
    {S_val1,S_val2,S_val3,S_val4,S_val5,S_val6},0,{'point','point','point','point','point','point'});
...
obj_stem_par.sigma_eta = diag([0.02 0.5 0.02 0.1 0.1 0.1]);
obj_stem_par.G = diag(0.9*ones(6,1));
obj_stem_par.sigma_eps = diag([0.02 0.5 0.02 0.02 0.1 0.1]); 
