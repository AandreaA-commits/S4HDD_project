...
NOx_lat_train = NOX{1,1}{:,3}(indici_righe_train1, :);
NOx_long_test = NOX{1,1}{:,4}(indici_righe_test1, :);
PM25_lat_train = PM25{1,1}{:,3}(indici_righe_train2, :);
PM25_long_test = PM25{1,1}{:,4}(indici_righe_test2, :);
...
% KRINGING NOX
krig_coordinates_NOx = [NOx_lat(indici_righe_test1), NOx_long(indici_righe_test1)];
