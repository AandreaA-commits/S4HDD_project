...
indici_totali7 = 1:ns7;
indici_righe_train7 = randperm(ns7, numero_righe7);
indici_righe_test7 = setdiff(indici_totali7, indici_righe_train7);
...
dati_train_PRESSIONE = dati_PRESSIONE(indici_righe_train7, :);
dati_test_PRESSIONE = dati_PRESSIONE(indici_righe_test7, :);
...
ground.Y{5} = dati_PRECIPITAZIONI;
ground.Y_name{5} = 'prec';
...
ground.coordinates{1} = [PM25_lat(indici_righe_train2), PM25_long(indici_righe_train2)];
...
ground.coordinates{5} = [PRECIPITAZIONI_lat, PRECIPITAZIONI_long];
